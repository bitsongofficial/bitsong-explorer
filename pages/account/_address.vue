                ...
                <v-row no-gutters>
                  ...
                  <v-col cols="12" class="hidden-sm-and-up" align="center">
                    <div class="display-1 font-weight-light grey--text text--darken-4">
                      {{ totalBalance | toBtsg }}
                      <span class="subtitle-1">COMMERCIO</span>
                    </div>
                    <div class="subtitle-1 grey--text text--darken-1 pt-1">Total COMMERCIO Balance</div>
                  </v-col>
                  <v-col cols="12" md="4">
                    <v-row>
                      <v-col cols="12">
                    ...
                    <v-row v-if="commissions > 0">
                      <v-col cols="12">
                        ...
                        >{{ (commissions - account.balances.rewards) | toBtsg }} COMMERCIO</div>
          ...
          <v-col cols="12" md="6">
            <v-card class="elevation-1">
              ...
              >
                ...
                <template v-slot:item.shares="{ item }">{{ item.shares | toBtsg }} COMMERCIO</template>
              </v-data-table>
            </v-card>
          </v-col>
          ...
          <v-col cols="12" md="6">
            <v-card class="elevation-1">
              ...
              >
                ...
                <template v-slot:item.amount="{ item }">{{ item.amount | toBtsg}} COMMERCIO</template>
          ...
          <v-col cols="12">
            <v-card class="elevation-1">
              ...
              >
                ...
                <template v-slot:item.balance="{ item }">{{ item.balance | toBtsg }} COMMERCIO</template>
                <template v-slot:item.completion_time="{ item }">{{ item.completion_time | toTime }}</template>
              </v-data-table>
            </v-card>
          </v-col>
